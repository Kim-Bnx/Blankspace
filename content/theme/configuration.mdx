...
<AdminPanelHelper
    ...
    actions={[["Changer de version", "Oui"]]}
/>

<Callout type="warning" title="Changer de version">
    Il est possible de changer la version de son forum après sa création.
    Attention : ce changement opère une réinitialisation complète des templates
    et du CSS. Pensez à sauvegarder vos modifications avant toute manipulation.
</Callout>
...
<AdminPanelHelper
    ...
    actions={[["Activer la gestion des codes Javascript", "Oui"]]}
/>
...
<AdminPanelHelper
    ...
    actions={[
        [
            "Niveau de compression de l'index",
...
<AdminPanelHelper
    ...
    actions={[["Afficher la description des sujets", "Oui"]]}
/>
...
<AdminPanelHelper
    ...
    actions={[["Voir le profil avancé", "Non"]]}
/>

<AdminPanelHelper
    icon="User"
    breadcrumbs="Utilisateurs & Groupes, Permissions spéciales"
    actions={[["Voir le profil", "Invités"]]}
/>

<Callout type="info">
    Cette configuration est nécessaire pour assurer le bon fonctionnement : - de
    l’affichage des avatars dans le Hub (QEEL modernisé) - de la visionneuse de
    profil Wombat
</Callout>
...
<Callout type="warning">
    Les utilisateurs inscrits avant l’activation du HTML devront modifier
    manuellement ce paramètre dans leurs préférences de profil.
</Callout>
