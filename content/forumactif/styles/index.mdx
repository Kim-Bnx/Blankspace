...
<AdminPanelHelper icon="Palette" breadcrumbs="Affichage, Images et Couleurs, CSS Principal" />
...
<Callout type="warning" title="Limitation du CSS sur Forumactif">
...
Envisagez de condenser le code de base, supprimer les commentaires superflus et les espaces une fois que vous avez bien pris en main le thème.
</Callout>
