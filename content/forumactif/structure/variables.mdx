...
```html
{USERNAME} {FORUM_NAME} {POST_SUBJECT}
```
...
```html
<!-- BEGIN topicrow -->
<div class="topic">{topicrow.TOPIC_TITLE}</div>
<!-- END topicrow -->
```
...
<strong>
    <a href="/u2" class="gensmall"
        ><span class="group-4 color-groups" style="color:#EB8F5E"
            ><strong>Kim</strong></span
        ></a
    >
</strong>
&nbsp;
<a href="/t6p30-cey-note#92" class="last-post-icon">
    <img
        src="https://2img.net/i/fa/modernbb/icon_topic_latest.png"
