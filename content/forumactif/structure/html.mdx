Le HTML (_HyperText Markup Language / langage de balisage pour l’hypertexte_) est le langage utilisé pour créer et structurer le contenu d’une page web.
...
<Callout type="info" title="Propriété par défaut">
Il n’est pas toujours possible de deviner les propriétés par défaut d’une balise. Ces connaissances s’acquièrent avec la pratique et la consultation de la documentation officielle.
...
C’est l’erreur la plus courante en HTML. Elle engendre un résultat inattendu (et parfois spectaculaire) : signe que le problème est une simple erreur de syntaxe.
...
```html
<a href="/t123">Voir le sujet</a> <img src="avatar.png" alt="Avatar" />
```
...
<Callout type="info" title="Attributs spécifiques">
...
Vous trouvez de nombreux commentaires dans les codes du Blank. Ils sont essentiels pour indiquer ce à quoi on a à faire.
