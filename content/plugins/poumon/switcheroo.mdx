...
title: Switcheroo
author: Poumon
description: Switcheroo est un plugin qui regroupe vos comptes dans une barre de navigation pour passer de l’un à l’autre en un seul clic. Son interface intuitive, combinée à des options d’installation et de personnalisation simples, vous permet de l’intégrer facilement aux couleurs de votre forum.
icon: switcheroo
version: 1.0.0
release_date: 01/2021
---
...
- `switcheroo.js` est le fichier principal qui permet d'appeler le plugin Switcheroo. Ce sont ces fichiers que vous trouvez dans ce repository Github. En les important d e cette façon, en cas de mise à jour du plugin, vous n'aurez rien à modifier.
